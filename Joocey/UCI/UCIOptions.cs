...
namespace UCI
{
    ...
    {
        public const string DebugLogFile = "Debug Log File";
        public const string Contempt = "Contempt";
        public const string AnalysisContempt = "Analysis Contempt";
        ...
        public const string UCI_Chess960 = "UCI_Chess960";
        ...
        public const string StockFish_BestBookMove = "BestBookMove";
        public const string StockFish_OwnBook = "OwnBook";
        public const string StockFish_BookFile = "BookFile";
